...
if ($reqPath === 'robots.txt') {
    ...
    /* [12.08.2026] Marque de diagnostic, temporaire. Elle dit d'un coup d'oeil
       quelle version de ce fichier tourne vraiment, sans dépendre d'aucun
       module ni d'aucune page. A retirer une fois le Catalogue en place. */
    echo "# build V42-CATALOGUE\n";
